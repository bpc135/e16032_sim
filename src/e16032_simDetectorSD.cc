...
e16032_simDetectorSD::e16032_simDetectorSD(G4String name)
  :G4VSensitiveDetector(name), HCID(-1)
{  
  // G4cout<<"e16032_simDetectorSD"<<G4endl;
  G4String HCname;
...
e16032_simDetectorSD::~e16032_simDetectorSD(){;
  // G4cout<<"~e16032_simDetectorSD"<<G4endl;
}

void e16032_simDetectorSD::Initialize(G4HCofThisEvent*HCE)
{
  // G4cout<<"e16032_simDetectorSD Initialize"<<G4endl;
  //static int HCID = -1;
  scintCollection = new e16032_simDetectorHitsCollection
...
G4bool e16032_simDetectorSD::ProcessHits(G4Step*aStep,G4TouchableHistory*ROhist)
{
  // G4cout<<"e16032_simDetectorSD ProcessHits"<<G4endl;
  ...
  // G4cout<<" Before '' aHit = new e16032_simDetectorHit();'' "<<G4endl; 
  
  aHit = new e16032_simDetectorHit();
  ...
  //   e16032_simTrackInformation *info = (e16032_simTrackInformation*)(aStep->GetTrack()->GetUserInformation());
...
void e16032_simDetectorSD::EndOfEvent(G4HCofThisEvent*)
{;}

void e16032_simDetectorSD::clear()
{
} 

void e16032_simDetectorSD::DrawAll()
{
} 

void e16032_simDetectorSD::PrintAll()
{
} 
