...
#include "e16032_simSteppingAction.hh"
...
e16032_simSteppingAction::e16032_simSteppingAction()
{ 
  //  G4cout<<"e16032_simSteppingAction"<<G4endl;
}
...
void e16032_simSteppingAction::UserSteppingAction(const G4Step* fStep) 
{
  //  G4cout<<"e16032_simSteppingAction UserSteppingAction"<<G4endl;
  if(fStep->GetTrack()->GetParentID()!=0){
    e16032_simTrackInformation *info = (e16032_simTrackInformation*)(fStep->GetTrack()->GetUserInformation());
...
//     G4int StepNo = fTrack->GetCurrentStepNumber();
 ...
 //     G4String particleName = fTrack->GetDefinition()->GetParticleName();
	...
	// - fStep->GetPreStepPoint()->GetLocalTime(); // do we have to take out the local time?
      ...
      //e16032_simAnalysisManager* analysis = e16032_simAnalysisManager::getInstance();
	...
	//  G4String particleName = fTrack->GetDefinition()->GetParticleName();
	  ...
	  //
	  //e16032_simAnalysisManager::getInstance()->AddParticle(particleName, energy, weight, time);
	}
      }
    }
  }
  ...
  if (fTrack->GetTrackID() != 1 ) {
	...
	//e16032_simAnalysisManager::getInstance()->AddEnergy(edep,weight,time);
      }
    }
  }
#endif  
