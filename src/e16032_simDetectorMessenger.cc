...
#include "e16032_simDetectorMessenger.hh"
...
e16032_simDetectorMessenger::e16032_simDetectorMessenger(e16032_simDetectorConstruction* myDet)
:myDetector(myDet)
{ 
  // G4cout<<"gedssdnrDetectorMessenger"<<G4endl;
  e16032_simDir = new G4UIdirectory("/e16032_sim/");
  e16032_simDir->SetGuidance("UI commands specific to this example.");
  
  detDir = new G4UIdirectory("/e16032_sim/det/");
  detDir->SetGuidance("detector control.");
  
  GeThickDetectorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/e16032_sim/det/setGeThickDetectorThickness",this);
  ...
  GeThickDetectorRadiusCmd = new G4UIcmdWithADoubleAndUnit("/e16032_sim/det/setGeThickDetectorRadius",this);
  ...
  GeThickDetectorMatCmd = new G4UIcmdWithAString("/e16032_sim/det/setGeThickDetectorMate",this);
  ...
  GeThinDetectorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/e16032_sim/det/setGeThinDetectorThickness",this);
  ...
  GeThinDetectorRadiusCmd = new G4UIcmdWithADoubleAndUnit("/e16032_sim/det/setGeThinDetectorRadius",this);
  ...
  GeThinDetectorMatCmd = new G4UIcmdWithAString("/e16032_sim/det/setGeThinDetectorMate",this);
  ...
  DetectorSpacingCmd = new G4UIcmdWithADoubleAndUnit("/e16032_sim/det/setDetectororSpacing",this);
  ...
  UseGeThickDetectorCmd = new G4UIcmdWithABool("/e16032_sim/det/UseGeThickDetector",this);
  ...
  UseGeThinDetectorCmd = new G4UIcmdWithABool("/e16032_sim/det/UseGeThinDetector",this);
  ...
  UseGeThickDetectorCryoCmd = new G4UIcmdWithABool("/e16032_sim/det/UseGeThickDetectorCryo",this);
  ...
  UseGeThickDetectorCryoEndCapCmd = new G4UIcmdWithABool("/e16032_sim/det/UseGeThickDetectorCryoEndCap",this);
  ...
  UseSegaCmd = new G4UIcmdWithABool("/e16032_sim/det/UseSega",this);
  ...
  UseCloverCmd = new G4UIcmdWithABool("/e16032_sim/det/UseClover",this);
  ...
  UseLaBr3Cmd = new G4UIcmdWithABool("/e16032_sim/det/UseLaBr3",this);
  ...
  UseLaBr3FrameCmd = new G4UIcmdWithABool("/e16032_sim/det/UseLaBr3Frame",this);
  ...
  Use3HenCmd = new G4UIcmdWithABool("/e16032_sim/det/Use3Hen",this);
  ...
  //BC - use MTC
  UseMTCCmd = new G4UIcmdWithABool("/e16032_sim/det/UseMTC",this);
  UseMTCCmd->SetGuidance("activate MTC");
  UseMTCCmd->SetParameterName("choice",false);
  UseMTCCmd->AvailableForStates(G4State_PreInit);
  
  //BC - use LENDA
  UseLENDACmd = new G4UIcmdWithABool("/e16032_sim/det/UseLENDA",this);
  ...
  //BC - use Getest
  UseGetestCmd = new G4UIcmdWithABool("/e16032_sim/det/UseGetest",this);
  ...
  UseEXOtestCmd = new G4UIcmdWithABool("/e16032_sim/det/UseEXOtest",this);
  ...
  UseEJ204ScintCmd = new G4UIcmdWithABool("/e16032_sim/det/UseEJ204Scint",this);
  ...
  //BC - use PSPMT
  UsePSPMTCmd = new G4UIcmdWithABool("/e16032_sim/det/UsePSPMT",this);
  ...
  //BC - use PSPMTCathode
  UsePSPMTCathodeCmd = new G4UIcmdWithABool("/e16032_sim/det/UsePSPMTCathode",this);
  UsePSPMTCathodeCmd ->SetGuidance("activate PSPMTCathode");
  UsePSPMTCathodeCmd ->SetParameterName("choice",false);
  UsePSPMTCathodeCmd ->AvailableForStates(G4State_PreInit);

  //BC - use PSPMTWindow
  UsePSPMTWindowCmd = new G4UIcmdWithABool("/e16032_sim/det/UsePSPMTWindow",this);
  UsePSPMTWindowCmd ->SetGuidance("activate PSPMTWindow");
  UsePSPMTWindowCmd ->SetParameterName("choice",false);
  UsePSPMTWindowCmd ->AvailableForStates(G4State_PreInit);

  //BC - use SiDSSD
  UseSiDSSDCmd = new G4UIcmdWithABool("/e16032_sim/det/UseSiDSSD",this);
  ...
  //BC - use beam pipe
  UsePipeCmd = new G4UIcmdWithABool("/e16032_sim/det/UsePipe",this);
...
e16032_simDetectorMessenger::~e16032_simDetectorMessenger()
{
  //G4cout<<"~gedssdnrDetectorMessenger"<<G4endl;
...
void e16032_simDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{ 
...
else if (command == UsePSPMTCathodeCmd )
    { myDetector->setUsePSPMTCathode(UsePSPMTCathodeCmd->GetNewBoolValue(newValue));}
  else if (command == UsePSPMTWindowCmd )
    { myDetector->setUsePSPMTWindow(UsePSPMTWindowCmd->GetNewBoolValue(newValue));}
