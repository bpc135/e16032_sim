...
#include "e16032_simAnalysisExample.hh"
#include "e16032_simAnalysisExampleMessenger.hh"

#include "e16032_simDetectorHit.hh"
//#include "e16032_simscintHit.hh"
//#include "e16032_simPMTHit.hh"
...
e16032_simAnalysisExample::e16032_simAnalysisExample(){

  //cout<<"e16032_simAnalysisExample"<<endl;
  analysisexample = new e16032_simAnalysisExampleMessenger(this);
  ...
  e16032_simtree = (TTree *)0; // e16032_sim out tree
...
void e16032_simAnalysisExample::Construct(const G4VPhysicalVolume */*theWorldWolume*/)
{
  // cout<<"e16032_simAnalysisExample Construct"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
  if (gSystem) gSystem->ProcessEvents();
...
void e16032_simAnalysisExample::ConstructParticle()
{
  //  cout<<"e16032_simAnalysisExample ConstructParticle"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::ConstructProcess()
{
  //  cout<<"e16032_simAnalysisExample ConstructProcess"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::SetCuts()
{
  //  G4cout<<"e16032_simAnalysisExample SetCuts"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::GeneratePrimaries(const G4Event *anEvent,G4double beam)
{
  // G4cout<<"e16032_simAnalysisExample GeneratePrimaries"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
  if (gSystem) gSystem->ProcessEvents();
...
//void e16032_simAnalysisExample::ResetStartLocation(G4double &newx, G4double &newy)
//{
  // #if defined (G4ANALYSIS_USE_ROOT)
  //   if (gSystem) gSystem->ProcessEvents();
...
void e16032_simAnalysisExample::DetectorInfo(e16032_simDetectorConstruction* myDet){
  ...
  e16032_siminfo = (TTree *)gROOT->FindObject("e16032_siminfo");
  if(e16032_siminfo);
  else{
    e16032_siminfo = new TTree("e16032_siminfo","e16032_siminfo variables");
    e16032_siminfo->Branch("UseGeThickDetector",&UseGeThickDetector,"UseGeThickDetector/I");
    e16032_siminfo->Branch("UseGeThinDetector",&UseGeThinDetector,"UseGeThinDetector/I");
    e16032_siminfo->Branch("GeThickDetectorThickness",&GeThickDetectorThickness,"GeThickDetectorThickness/D");
    e16032_siminfo->Branch("GeThinDetectorThickness",&GeThinDetectorThickness,"GeThinDetectorThickness/D");
    e16032_siminfo->Branch("GeThickDetectorRadius",&GeThickDetectorRadius,"GeThickDetectorRadius/D");
    e16032_siminfo->Branch("GeThinDetectorRadius",&GeThinDetectorRadius,"GeThinDetectorRadius/D");
    e16032_siminfo->Branch("GeThickx",&GeThickx,"GeThickx/D");
    e16032_siminfo->Branch("GeThicky",&GeThicky,"GeThicky/D");
    e16032_siminfo->Branch("GeThickz",&GeThickz,"GeThickz/D");
    e16032_siminfo->Branch("GeThinx",&GeThinx,"GeThinx/D");
    e16032_siminfo->Branch("GeThiny",&GeThiny,"GeThiny/D");
    e16032_siminfo->Branch("GeThinz",&GeThinz,"GeThinz/D");
    e16032_siminfo->Branch("GeSpacing",&GeSpacing,"GeSpacing/D");
  }
  e16032_siminfo->Fill();
...
void e16032_simAnalysisExample::BeginOfRunAction(const G4Run */*aRun*/, G4int rank)
{
  //  cout<<"e16032_simAnalysisExample BeginOfRunAction"<<endl;
  eventcounter = 0;
  ...
  e16032_simtree = (TTree *)gROOT->FindObject("e16032_simtree");
  if(e16032_simtree);
  else
    {
      e16032_simtree = new TTree("e16032_simtree","DSSD hit variables");
      e16032_simtree->Branch("e16032_sim_energy",&e16032_sim_energy,"e16032_sim_energy/D");
      e16032_simtree->Branch("totE",&totE,"totE/D");
      e16032_simtree->Branch("beam_energy",&beam_energy,"beam_energy/D");
      e16032_simtree->Branch("pathlength",&pathlength,"pathlength/D");
      e16032_simtree->Branch("totaledep",&totaledep,"totaledep/D");
      e16032_simtree->Branch("tedepx",&tedepx,"tedepx[20]/D");
      e16032_simtree->Branch("tedepy",&tedepy,"tedepy[20]/D");
...
void e16032_simAnalysisExample::EndOfRunAction(const G4Run */*aRun*/, G4int rank)
{
  ...
  //file1 = new TFile(filenam.c_str(),"RECREATE");
  //e16032_siminfo->SetDirectory(file1);
  file1->cd();
  gROOT->SetStyle("Pub");
...
void e16032_simAnalysisExample::BeginOfEventAction(const G4Event */*anEvent*/)
{
  // cout<<"e16032_simAnalysisExample BeginOfEventAction"<<endl;
...
void e16032_simAnalysisExample::EndOfEventAction(const G4Event *evt)
{    
  ...
  e16032_simDetectorHitsCollection *DHC = 0;
  e16032_simDetectorHitsCollection *DHCthin = 0;
  e16032_simDetectorHitsCollection *DHCsega = 0;
  e16032_simDetectorHitsCollection *DHCClover = 0;
  //BC - add LaBr3 to detector hits collection
  e16032_simDetectorHitsCollection *DHClabr3 = 0;
  //BC - add Getest to detector hits collection
  e16032_simDetectorHitsCollection *DHCGetest = 0;
  //BC - add EXOtest to detector hits collection
  e16032_simDetectorHitsCollection *DHCEXOtest = 0;
  //BC - add EXOtest to detector hits collection
  e16032_simDetectorHitsCollection *DHCEJ204Scint = 0;
  e16032_simDetectorHitsCollection *DHCCeBr3Scint = 0;
  

  //G4int gammaincenter;
  //gammaincenter = 0;
  if(HCE){
    DHC = (e16032_simDetectorHitsCollection*)(HCE->GetHC(DetectorColID));
    DHCthin = (e16032_simDetectorHitsCollection*)(HCE->GetHC(GeThinDetectorColID));
    DHCsega = (e16032_simDetectorHitsCollection*)(HCE->GetHC(SegaDetectorID));
    DHCClover = (e16032_simDetectorHitsCollection*)(HCE->GetHC(CloverColID));
    //BC - handle HC (hit collection) for LaBr3
    DHClabr3 = (e16032_simDetectorHitsCollection*)(HCE->GetHC(LaBr3ColID));
    //BC - handle hit collection for Getest
    DHCGetest = (e16032_simDetectorHitsCollection*)(HCE->GetHC(GetestColID));
    DHCEXOtest = (e16032_simDetectorHitsCollection*)(HCE->GetHC(EXOtestColID));
    DHCEJ204Scint = (e16032_simDetectorHitsCollection*)(HCE->GetHC(EJ204ScintColID));
    DHCCeBr3Scint = (e16032_simDetectorHitsCollection*)(HCE->GetHC(CeBr3ScintColID));
  }
...
void e16032_simAnalysisExample::ClassifyNewTrack(
...
void e16032_simAnalysisExample::NewStage()
{
  // cout<<"e16032_simAnalysisExample NewStage"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::PrepareNewEvent()
{
  //  cout<<"e16032_simAnalysisExample PreparNewEvent"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::PrepareNewRun(G4double x, G4double y, G4double z, G4double zpos,
					     G4int r, G4int c)
{
  // cout<<"e16032_simAnalysisExample PrepareNewRun"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::PreUserTrackingAction(const G4Track */*aTrack*/)
{
  //   cout<<"e16032_simAnalysisExample PreUserTrackingAction"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
  if (gSystem) gSystem->ProcessEvents();
...
void e16032_simAnalysisExample::PostUserTrackingAction(const G4Track */*aTrack*/,
						      G4TrackStatus */*status_ptr*/)
{
  // cout<<"e16032_simAnalysisExample PostUserTrackingAction"<<endl;
...
void e16032_simAnalysisExample::UserSteppingAction(const G4Step *aStep)
{
  //  cout<<"e16032_simAnalysisExample UserSteppingAction"<<endl;
#if defined (G4ANALYSIS_USE_ROOT)
...
void e16032_simAnalysisExample::OnceAWhileDoIt(const G4bool DoItNow)
{
  //  cout<<"e16032_simAnalysisExample OnceAWhileDoIt"<<endl;
  ...
  const char OnceAWhileCanvas[] = "e16032_simAnalysisExampleCanvas";
...
// end of file e16032_simAnalysisExample.cc by Jacek M. Holeczek

void e16032_simAnalysisExample::Setfilename(G4String nam)
{
  filename = nam;
}

void e16032_simAnalysisExample::Setdirname(G4String nam)
{
  dirname = nam;
}

//void e16032_simAnalysisExample::OpticalPhotons(G4int status, G4double val)
//{
  //   if(status == 1){
  //     opticalphoton++;
  //   }
...
//void e16032_simAnalysisExample::PSF(G4int status, G4double val1, G4double val2)
//{
  
  //   if(status == 0){
  //     e16032_simap_len = e16032_simap_len + val1;
  //   }
  //   else if(status == 1){
  //     psfx = val1;
  //     psfy = val2;
  //     htally->Fill(psfx,psfy);
  //     hpsf->Fill(psfx,psfy,exp(-e16032_simap_len/5));
  //   }
