...
//#include "e16032_simMaterialData.hh"
#include "e16032_simMaterialMessenger.hh"
...
////////////////////////////////////////////////////////////////////////////////
//
e16032_simMaterial::e16032_simMaterial ()
{
  ...
  // Elements
  // G4cout<<"e16032_simMaterial"<<G4endl;
  ...
  materialMessenger = new e16032_simMaterialMessenger(this);
}
////////////////////////////////////////////////////////////////////////////////
//
e16032_simMaterial::~e16032_simMaterial ()
...
//
/*
  void e16032_simMaterial::AddMaterial (G4String name, G4String formula, G4double density,
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  void e16032_simMaterial::DeleteMaterial (G4int j)
  {
  size_t i(j-1);
  if (i > Material.size()) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  void e16032_simMaterial::DeleteMaterial (G4String )
  {
  G4cerr <<"It seems there is no mechanism in G4 for deleting a material yet!"
  <<G4endl;
  G4cerr <<"--> Command rejected." <<G4endl;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //
  G4int e16032_simMaterial::GetMaterialIndex (G4String name)
  {
  size_t i ;
  for (i = 0; i < Material.size(); i++) {
...
////////////////////////////////////////////////////////////////////////////////
//
void e16032_simMaterial::ListMaterial ()
{
