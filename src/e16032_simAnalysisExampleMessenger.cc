...
e16032_simAnalysisExampleMessenger::e16032_simAnalysisExampleMessenger
   (e16032_simAnalysisExample* SA):analysisexample(SA) {
  // cout<<"e16032_simAnalysisExampleMessenger"<<endl;

     analysisDir = new G4UIdirectory("/e16032_sim/analysis/");
     analysisDir->SetGuidance("event control");

     trackparentCmd = new G4UIcmdWithAnInteger("/e16032_sim/analysis/trackparent",this);
     ...
     trackdaughterCmd = new G4UIcmdWithAnInteger("/e16032_sim/analysis/trackdaughter",this);
     ...
     filenameCmd = new G4UIcmdWithAString("/e16032_sim/analysis/filename",this);
     ...
     dirnameCmd = new G4UIcmdWithAString("/e16032_sim/analysis/dirname",this);
...
//ooooooooooooooooooooooooooooooooooooooooo
void e16032_simAnalysisExampleMessenger::SetNewValue(G4UIcommand* command, 
  G4String newValue) {
