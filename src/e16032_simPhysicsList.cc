...
#include "e16032_simPhysicsList.hh"
#include "e16032_simPhysicsListMessenger.hh"

//#include "e16032_simPhysListParticles.hh"
#include "G4EmStandardPhysics.hh"
//#include "e16032_simPhysListEmLowEnergy.hh"
//#include "e16032_simPhysListHadron.hh"
...
e16032_simPhysicsList::e16032_simPhysicsList() : G4VModularPhysicsList()
{
  ...
  pMessenger = new e16032_simPhysicsListMessenger(this);
...
e16032_simPhysicsList::~e16032_simPhysicsList()
{
  delete pMessenger;
  delete raddecayList;
...
void e16032_simPhysicsList::ConstructParticle()
{
...
void e16032_simPhysicsList::ConstructProcess()
{
  AddTransportation();
  // em
...
// had
  ...
  G4cout << "### e16032_simPhysicsList::ConstructProcess is done" << G4endl;

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void e16032_simPhysicsList::SelectPhysicsList(const G4String& name)
{
  if (verboseLevel>1) {
    G4cout << "e16032_simPhysicsList::SelectPhysicsList: <" << name << ">" << G4endl;
  }
  // default  Had physics
  if (name == "Hadron" && !hadPhysicsList) {
    // hadPhysicsList = new e16032_simPhysListHadron("hadron");
    ...
    //} else if (name == "LowEnergy_EM") {
      ...
      delete emPhysicsList;
      // emPhysicsList = new e16032_simPhysListEmLowEnergy("lowe-em");
      emPhysicsList = new G4EmLivermorePhysics();
      ...
      G4cout << "e16032_simPhysicsList WARNING wrong or unkonwn <" 
	     << name << "> Physics " << G4endl;
  }
}
...
void e16032_simPhysicsList::AddExtraBuilders(G4bool flagHP)
{
  nhadcomp = 5;
...
void e16032_simPhysicsList::SetCuts()
{
...
void e16032_simPhysicsList::SetCutForGamma(G4double cut)
{
  cutForGamma = cut;
...
void e16032_simPhysicsList::SetCutForElectron(G4double cut)
{
  cutForElectron = cut;
...
void e16032_simPhysicsList::SetCutForPositron(G4double cut)
{
  cutForPositron = cut;
...
void e16032_simPhysicsList::SetTargetCut(G4double cut)
{
...
void e16032_simPhysicsList::SetDetectorCut(G4double cut)
{
