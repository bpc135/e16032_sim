...
#include "e16032_simPrimaryGeneratorAction.hh"
...
int main(int argc,char** argv)
{
  ...
  e16032_simAnalysisExample* analysis = new e16032_simAnalysisExample();
  //e16032_simAnalysisManager* analysis = e16032_simAnalysisManager::getInstance();

  // set mandatory initialization classes

  e16032_simDetectorConstruction* Detector = new e16032_simDetectorConstruction;
  runManager->SetUserInitialization(Detector);
  runManager->SetUserInitialization(new e16032_simPhysicsList);
