...
// ********************************************************************
//
#ifndef e16032_simDetectorConstruction_h
#define e16032_simDetectorConstruction_h 1

#include "globals.hh"
#include "G4ThreeVector.hh"
#include "G4VUserDetectorConstruction.hh"
//#include "e16032_simMagneticField.hh"
...
class G4Material;
class G4Region;
class e16032_simDetectorMessenger;
class e16032_simMaterial;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

class e16032_simDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
  
     e16032_simDetectorConstruction();
    ~e16032_simDetectorConstruction();
  ...
  // set whether or not PSPMTCathode&PSPMTWindow will be used (e14057 + e16032)
     void setUsePSPMTCathode( G4bool value) {fUsePSPMTCathode = value;};
     void setUsePSPMTWindow( G4bool value) {fUsePSPMTWindow = value;};
  ...
  private: 
     ...
     e16032_simDetectorMessenger* detectorMessenger;  // pointer to the Messenger
     e16032_simMaterial* materialsManager;            // material manager
...
//      G4VPhysicalVolume* physiTIGRESSCryo;         // pointer to the physical TIGRESS Cryo     
 ...
 G4bool fUsePSPMTCathode;                            //flag to determine if PSPMT is used
