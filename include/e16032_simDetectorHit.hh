...
#ifndef e16032_simDetectorHit_h
#define e16032_simDetectorHit_h 1
...
class e16032_simDetectorHit : public G4VHit
{
  public:

      e16032_simDetectorHit();
      ~e16032_simDetectorHit();
      e16032_simDetectorHit(const e16032_simDetectorHit &right);
      const e16032_simDetectorHit& operator=(const e16032_simDetectorHit &right);
      G4int operator==(const e16032_simDetectorHit &right) const;
...
typedef G4THitsCollection<e16032_simDetectorHit> e16032_simDetectorHitsCollection;

extern G4Allocator<e16032_simDetectorHit> e16032_simDetectorHitAllocator;

inline void* e16032_simDetectorHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) e16032_simDetectorHitAllocator.MallocSingle();
  return aHit;
}

inline void e16032_simDetectorHit::operator delete(void *aHit)
{
  e16032_simDetectorHitAllocator.FreeSingle((e16032_simDetectorHit*) aHit);
}
